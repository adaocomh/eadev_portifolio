...
export default function MeuObjetivo() {
    return (
                <div className='flex justify-center items-center min-h-[100vh] max-w-[100vw] bg-linear-[180deg,rgba(0,0,0,0.020)5%,rgba(245,236,219,1)95%] overflow-hidden' id='sS2'>
